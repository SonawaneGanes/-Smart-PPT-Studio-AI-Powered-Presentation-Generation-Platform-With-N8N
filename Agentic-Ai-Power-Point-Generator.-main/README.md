...
📝 Prompt-based PPT creation (idea → full presentation)

🎨 Modern, professional slide design

⚙️ Python-based PowerPoint automation using python-pptx

🌐 Interactive Streamlit web interface

🔗 n8n webhook integration for AI orchestration
...
## 📂 Project Structure:
    ...
    ├── app1.py               # AI-generated PPT automation script
...
2. Prompt is sent to an Agentic AI workflow (via n8n)

3. AI generates production-ready Python code using python-pptx
